export const toolSeeds = {
  ...
  Frontend: [
    ...
    "Bootstrap", "Bulma", "daisyUI", "Chakra UI", "MUI", "Radix UI", "shadcn/ui", "Ant Design",
  ...
  Backend: [
    ...
    "Django", "Flask", "FastAPI", "Pydantic", "Ruff", "uv", "pytest", "Spring Boot", "Laravel", "Symfony", "Ruby on Rails",
  ...
  "Data and AI": [
    ...
    "Groq", "Claude", "Claude Code", "Mistral AI", "DeepSeek", "Perplexity", "OpenRouter", "Replicate",
