export const toolSeeds = {
  ...
  Frontend: [
    ...
    "Mantine", "Storybook", "Cypress", "Playwright", "Vitest", "Jest", "Mocha",
  ...
  Backend: [
    ...
    "Phoenix Framework", ".NET", "ASP.NET Core", "Apollo GraphQL", "tRPC", "Prisma",
  ...
  "Cloud and DevOps": [
    ...
    "OpenTelemetry", "PagerDuty", "Uptime Kuma", "ngrok", "Tailscale", "WireGuard"
  ],
  "Mobile and Desktop": [
...
export const featuredOrder = [
  "TypeScript", "React", "Next.js", "Tailwind CSS", "Node.js", "Python", "FastAPI",
  "PostgreSQL", "Supabase", "Docker", "Git", "GitHub", "Cloudflare", "Vercel", "Figma"
];
